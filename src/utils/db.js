...
function migrateItem(item) {
  ...
  return {
    ...
    manualOrder: item.manualOrder != null ? item.manualOrder : undefined,
    ...
    db.defaults({
      todoList: [
          ...
          children: [
            {
              ...
              todo_date: getNowDate(),
              todo_datetime: getNowDateTime(),
              content: "🌳 多级子项目：点击编辑区 + 按钮可添加子项目，支持拖拽重组",
              priority: null,
              color: "#f59e0b",
              children: [
                {
            ...
            },
            {
              ...
              todo_date: getNowDate(),
              todo_datetime: getNowDateTime(),
              content: "🎯 颜色系统：子项目自动继承父项目颜色，点击色块可自定义",
              priority: null,
              color: "#3b82f6",
              children: []
            },
            ...
            },
            {
              ...
              todo_date: getNowDate(),
              todo_datetime: getNowDateTime(),
              content: "⚙️ 层级配置：设置面板可为每级子项目独立设置字号/间距/缩进/编号",
              priority: null,
              color: null,
              children: []
            }
        ...
        },
        {
          ...
          todo_date: getNowDate(),
          todo_datetime: getNowDateTime(),
          content: "🔢 编号格式：设置面板支持 18 种编号格式，主项目与子项目独立配置",
          priority: null,
          color: "#10b981",
          children: []
        }
